...
class ChooseCountryTableViewController: UITableViewController {
    ...
    let countryArray = ["All Locations","Spain", "Japan", "France", "Germany", "Italy", "United Kingdom", "United States"]
...
//        print(cell?.textLabel?.text ?? String())
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showStoreSegue" {
            let nextScene = segue.destination as? StoreViewController
            
            nextScene?.countryToSelect = self.countrySelected as NSString!
